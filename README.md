...
|-------------|---------------------------------------------------------------|
| **Excel**   | Data cleaning, pivot tables, dashboards, IF/VLOOKUP logic     |
| **SQL (T-SQL)** | Querying, joins, aggregations, subqueries, analytics      |
| **Power BI**| Data modeling, DAX, slicers, KPIs, visuals, storytelling      |
| **Languages**| Fluent in English 🇬🇧, French 🇫🇷, and Yoruba 🏳️              |
---
...
*Link:* [📁 View Responses and Queries:[KMS_Case_Study_Executed_Results_Felix O. Oyekola.xlsx](https://github.com/user-attachments/files/20970405/KMS_Case_Study_Executed_Results_Felix.O.Oyekola.xlsx)
...
DASHBOARD OVERVIEW SCREENSHOT: <img width="915" alt="Dashboard Overview_Felix Oyekola" src="https://github.com/user-attachments/assets/d327beff-0d93-4809-b406-043eb8d87bff" />

![Uploading Dashboard Overview_Felix Oyekola.png…]()
...
| Palmoria HR Analytics | HR Analytics | Power BI | ✅ Completed |
| Amazon Review Excel Dashboard | Exploratory Data Analysis | Excel | ✅ Done |
